...
| SHACL | `0.15.4` |
| Schematron | `0.15.4` |
| Portfolio Manager | `0.16.4` |

Release tags are backend-specific, such as `energyplus-v0.15.5` and
`portfolio_manager-v0.16.4`. A failed or published tag is never moved or
...
|---|---|---|
| Wrapper version (`backends.toml` `release_version`) | `0.15.5` | Wrapper code, image layout, or output semantics change |
